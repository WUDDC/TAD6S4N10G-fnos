...
#
# Ships the backend `tad-module` (author's official v0.10.16 static binary, from
...
TANK_RELEASE_BACKEND="${TANK_RELEASE_BACKEND:-https://github.com/luodaoyi/TAD6S4N10G-fnos/releases/download/v0.10.16/tad-module.fpk}"
